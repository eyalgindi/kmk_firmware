...
keyboard.keymap = [
    [
        ...
        KC.F7, KC.F8, KC.LSFT, TD.Z, TD.X, TD.C, TD.V, TD.B,                    TD.N, TD.M, KC.COMM, KC.DOT, KC.SLSH, KC.RSFT, TD.UP, KC.PGDN,
        TD.F9, TD.F10, KC.LCTL, KC.LALT, KC.LGUI, KC.LGUI, HT.SPC_FN,             HT.SPC_FN, KC.RALT, KC.RCTL, KC.RGUI, TD.LEFT, TD.DOWN, TD.RGHT
    ],
