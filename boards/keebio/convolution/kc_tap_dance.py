...
LEFT = KC.TD(KC.LEFT, KC.HT(KC.LALT(KC.LEFT), KC.LGUI(KC.LEFT)), tap_time=70)
RGHT = KC.TD(KC.RGHT, KC.HT(KC.LALT(KC.RGHT), KC.LGUI(KC.RGHT)), tap_time=70)
UP   = KC.TD(KC.UP, KC.HT(KC.LALT(KC.UP), KC.LGUI(KC.UP)), tap_time=70)
DOWN = KC.TD(KC.DOWN, KC.HT(KC.LALT(KC.DOWN), KC.LGUI(KC.DOWN)), tap_time=70)
